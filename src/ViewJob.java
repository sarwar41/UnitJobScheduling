...
//		String sort_type = (String) scheduleDropdown.getSelectedItem();
//        tableModel = new DefaultTableModel(data.scheduleTasks(data.getAllTasks(user_id), sort_type), columns);
